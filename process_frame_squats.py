...
class ProcessFrame:
    def __init__(self, thresholds, flip_frame = False):
        ...
        self.state_tracker = {
            ...
            # 0 --> Bend Backwards, 1 --> Bend Forward, 2 --> Keep shin straight, 3 --> Deep squat, 4 --> Asymmetry
        ...
        self.FEEDBACK_ID_MAP = {
                                ...
                                4: ('WEIGHT SHIFT DETECTED', 260, (255, 50, 50))
                               }
        ...
        if keypoints.pose_landmarks:
            ...
            # Camera is aligned properly.
                ...
                if current_state in ['s2', 's3']:
                    hip_diff = abs(left_hip_coord[1] - right_hip_coord[1])
                    if hip_diff > 30: # Asymmetrical drop threshold
                        self.state_tracker['DISPLAY_TEXT'][4] = True
                        self.state_tracker['INCORRECT_POSTURE'] = True
                        log_mistake("Asymmetrical Squat Load")
